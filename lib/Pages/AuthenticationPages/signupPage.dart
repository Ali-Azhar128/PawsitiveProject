...
import 'package:pawsitive1/Pages/AuthenticationPages/phoneVerificationPage.dart';
    ...
    Future<void> createUser(String email, String pass, String userName) async {
      ...
      try {
        ...
        Get.to(() => PhoneVerificationPage(
            email: email, password: pass, name: userName, user: user));
                            ...
                            child: Text(
                              ...
                              style: GoogleFonts.poppins(
                                textStyle: TextStyle(
                                    ...
                                    fontWeight:
                                        FontWeight.w900, // Make the text bold
